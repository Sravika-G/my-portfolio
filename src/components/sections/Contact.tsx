...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`mailto:sravikagillela02@gmail.com?subject=${subject}&body=${body}`, '_self');
    toast({
      title: "Opening email client",
      description: "Your default email app should open with the message prefilled.",
    });
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      label: "Email",
      value: "sravikagillela02@gmail.com",
      href: "mailto:sravikagillela02@gmail.com"
    },
    {
      icon: Phone,
      label: "Phone",
      value: "909-663-6535",
      href: "tel:909-663-6535"
    },
    {
      icon: Linkedin,
      label: "LinkedIn",
